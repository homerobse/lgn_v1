...
#W_E_LGN_E_LGN = np.random.exponential(1, n_E_LGN*n_E_LGN)*5/1000000.
...
W_I_LGN_I_LGN = np.random.exponential(1, n_I_LGN*n_I_LGN)*0.
...
W_I_L4_I_L4 = np.random.exponential(1, n_I_L4*n_I_L4)*8/100000.
...
W_I_L6_I_L6 = np.random.exponential(1, n_I_L6*n_I_L6)*8/100000.
...
W_TRN_TRN = np.random.exponential(1, NGABA_trn*NGABA_trn)*14/1000000. #testing effect of connection weight
#W_TRN_TRN = np.random.exponential(1, NGABA_trn*NGABA_trn)*4/100000.
...
W_E_LGN_TRN = np.random.exponential(1, n_E_LGN*NGABA_trn)*14/1000000.
W_E_LGN_TRN = W_E_LGN_TRN.reshape((n_E_LGN, NGABA_trn))

W_TRN_E_LGN = np.random.exponential(1, NGABA_trn*n_E_LGN)*14/1000000.
W_TRN_E_LGN = W_TRN_E_LGN.reshape(NGABA_trn, n_E_LGN)
