...
def plot_all(c, OUTPUT_DIR, fname, n_sim, timeaxis, stim_rec, with_V1_L4, with_V1_L6, with_TRN,
    ...
    (Pxx, freqpsd) = psd(mean_lgn, nfft, Fs)  # args are signal, nfft, Fs
    plt.figure(8)
    ...
    sweep_f.write(str([[lgn_peak_freq, lgn_mean_peak_power], n_sim, c]))
    sweep_f.write("\n")
    # sweep_f.write("TRN\n")
