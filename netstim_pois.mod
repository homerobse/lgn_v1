: $Id: netstim_pois.mod 2212 2008-09-08 14:32:26Z hines $
: comments at end

NEURON	{ 
  ARTIFICIAL_CELL NetStimPois
  RANGE interval, number, start, mean
  RANGE noise
...
PARAMETER {
	...
	number	= 0 <0,1e9>	: number of spikes (independent of noise)
